...
import { FriendManagementModal, FriendsDashboardScreen } from '@/modules/relationships'; // Import FriendsDashboardScreen directly
...
export function DashboardScreen() {
    ...
    const { submitBatteryCheckin } = useUserProfile();
